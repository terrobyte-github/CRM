...
function NewXML(AEncoding: String = 'UTF-8'): IXMLDocument;
...
begin
  ...
  //Result := Utf8ToAnsi(String(FormatXMLData(WideString(AText))));
end;
...
begin
  ...
  try
    ...
    //Result := String(AnsiToUtf8(AnsiReplaceStr(sl.Text, sLineBreak, '')));
  finally
    sl.Free;
  end;
end;
