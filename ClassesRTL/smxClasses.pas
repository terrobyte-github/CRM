...
type
  ...
  TsmxManipulCell = class(TsmxActionCell)
  end;
...
begin
  ...
  begin
    ...
    IsEditing := TsmxCustomColumn(Source).IsEditing;
  end;
end;
...
function TsmxCustomColumn.GetIsEditing: Boolean;
begin
  Result := False;
end;

procedure TsmxCustomColumn.SetIsEditing(Value: Boolean);
begin
end;
